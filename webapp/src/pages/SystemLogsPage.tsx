  ...
  async function loadLogs() {
    try {
      ...
      setLogs([
        ...
        { id: '7', event_type: 'Info', event_code: 'STEP_START', message: 'Starting step 2 (Algorithm)', detail_json: null, pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'ALGORITHM', created_at: new Date(now.getTime() - 247000).toISOString(), node_id: 'worker-1' },
        { id: '8', event_type: 'Warn', event_code: 'ANOMALY_DETECTED', message: 'Anomaly detector found 3 outliers in batch (threshold: 0.95)', detail_json: '{"outliers":3,"threshold":0.95}', pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'ALGORITHM', created_at: new Date(now.getTime() - 246000).toISOString(), node_id: 'worker-1' },
        { id: '9', event_type: 'Info', event_code: 'STEP_DONE', message: 'Step 2 completed in 1,247ms — 147 normal, 3 anomalies', detail_json: '{"normal":147,"anomalies":3}', pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'ALGORITHM', created_at: new Date(now.getTime() - 245000).toISOString(), node_id: 'worker-1' },
        { id: '10', event_type: 'Info', event_code: 'STEP_START', message: 'Starting step 3 (Transfer)', detail_json: null, pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'TRANSFER', created_at: new Date(now.getTime() - 244000).toISOString(), node_id: 'worker-1' },
        { id: '11', event_type: 'Error', event_code: 'STEP_FAILED', message: 'Step 3 failed: connection timeout to S3 bucket (attempt 1/3)', detail_json: '{"error":"ConnectionTimeout","bucket":"hermes-output"}', pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'TRANSFER', created_at: new Date(now.getTime() - 243000).toISOString(), node_id: 'worker-1' },
        { id: '12', event_type: 'Info', event_code: 'STEP_RETRY', message: 'Retrying step 3, attempt 2/3, delay 5s', detail_json: null, pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'TRANSFER', created_at: new Date(now.getTime() - 238000).toISOString(), node_id: 'worker-1' },
        { id: '13', event_type: 'Info', event_code: 'STEP_RETRY_SUCCESS', message: 'Step 3 succeeded on retry 2 — 150 records transferred', detail_json: '{"records":150}', pipeline_id: 'p-001', pipeline_name: 'Sensor Data Pipeline', execution_id: 'e-001', step_type: 'TRANSFER', created_at: new Date(now.getTime() - 237000).toISOString(), node_id: 'worker-1' },
